...
ABOUT_TEXT: Final[str] = "Привет! Я Полубрюхов Матвей, разработчик этого бота. Я учусь в 7И классе Аэрокосмического Лицея г.Химки. Программирую на Python, C++. Пробовал себя в веб-разработке. На этом всё!"
